...
export class MagicSquareResult {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(MagicSquareResult.prototype);
        obj.__wbg_ptr = ptr;
        MagicSquareResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MagicSquareResultFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     */
    get n() {
        const ret = wasm.magicsquareresult_n(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('magic_squares_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
